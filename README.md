...
The website is designed to show any potential customer what 'The Old Railway Theatre' does and what special items it has that makes it different from other cinemas.
...
The colors were picked to best replicate the feel within a cinema, so a dark background and by contrast bright text has been used throughout the site.
...
- The navigation bar sits in the top right of the page opposite the sites title.

- On smaller screens the navigation bar sits below the site title.

### Footer

- The footer is consistant on each page and consists of the 3 social media links (Facebook, Twitter and Instagram). It also contains the copyright text.
...
- About section
    ...
    - This gives the user a few lines about how the Old Railway Theatre is different to other cinemas. This section also includes image(s) that show some of these differences, namely the gilded ticket collection kiosks.

- Map section

    - This allows the user to locate the theatre within the old railway quarter of Swindon by using the embedded google map.
...
- Three daily movie preview sections.
    ...
    - Each section also has a clickable link under the date that takes the user to the sign-up page with the promise that if they sign up they will receive a ticket booking line number in order to make a booking.
...
- The upcoming movies will need to be constantly updated as per the calendar of movies to be shown.
